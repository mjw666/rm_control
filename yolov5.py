...
class Darknet(object):
    ...
    def detect(self, dataset):
        ...
        for path, img, img0s, vid_cap in dataset:
            ...
            for i, det in enumerate(pred):
                ...
                buffer = cv2.imencode('.jpg', im0)[1].tobytes()
    ...
    # Plotting functions
    def plot_one_box_old(self, x, img, color=None, label=None, line_thickness=None):
    ...
    def plot_one_box(self, x, img, color=None, label=None, line_thickness=None):
      ...
      font = ImageFont.truetype('C:\Windows\simsun.ttc', 9)
      # Plots one bounding box on image img
      ...
      if label:
        ...
        if y1<0:
            y1=0
        draw.rectangle((c1[0], c1[1], c1[0] + text_size[0], y1))
